...
project = "SME-Identidade-Token-Microsservico"
author = "SME"
release = "0.1.0"
language = "pt_BR"
...
latex_documents = [
    (
        "index",
        "sme-identidade-token-microsservico.tex",
...
\fancyhead[L]{SME-Identidade Token Microsservico}
...
\begin{titlepage}
    ...
    {\Huge\bfseries SME Identidade Token Microsservico \par}
    \vspace{1cm}
